...
final List<Aviation> boardingTypes = [
  ...
  const Aviation(value: 7, text: 'Boeing737-7'),
  const Aviation(value: 8, text: 'Boeing737-5'),
  const Aviation(value: 9, text: 'Boeing787-10 (B78X)'),
  const Aviation(value: 10, text: 'Bombardier DHC8-Q400'),
  const Aviation(value: 11, text: 'Canadian Bombardier CRJ-700'),
  const Aviation(value: 20, text: 'Embraer190'),
  const Aviation(value: 21, text: 'Embraer170'),
  const Aviation(value: 30, text: 'Airbus A320'),
  const Aviation(value: 31, text: 'Airbus A321'),
  const Aviation(value: 40, text: 'Boeing747-4'),
  const Aviation(value: 60, text: 'Airbus A350-9'),
  const Aviation(value: 70, text: 'ATR42-6'),
];
